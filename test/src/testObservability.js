...
describe('TestObservability', function () {
  let testObservability; let sandbox;
  ...
  describe('processTestRunData', function () {
    let eventData; let sectionName; let testFileReport; let hookIds; let sendTestRunEventStub;
    beforeEach(() => {
      eventData = {commands: []};
